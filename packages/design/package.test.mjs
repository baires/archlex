...
assert.doesNotMatch(fonts, /@fontsource\/commit-mono\/\d+\.css/);
assert.match(fonts, /commit-mono-latin-400-normal\.woff2/);
assert.match(fonts, /commit-mono-latin-500-normal\.woff2/);
assert.doesNotMatch(fonts, /\.woff["')]/);
